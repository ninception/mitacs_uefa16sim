...
## For" question-1: group nums ####

groupnames <- c("A","B","C","D","E","F")
#change ylim value as needed.
barplot(rswgrp, ylim = c(0.125,0.185), main = "Quarter-finalists from each group", ylab = "Density", xlab = "Groups",  col = "lightblue", names.arg = groupnames, xpd = FALSE)
...
barplot(wingrp, ylim = c(0.1,0.21), main = "Cup winners from each group", ylab = "Density", xlab = "Groups",  col = "lightblue", names.arg = groupnames, xpd = FALSE)
